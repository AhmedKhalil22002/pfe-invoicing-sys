...
import { PurchaseQuotationArticleItem } from './PurchaseQuotationArticleItem';
...
interface PurchaseQuotationArticleManagementProps {
  className?: string;
  taxes: Tax[];
...
export const PurchaseQuotationArticleManagement: React.FC<PurchaseQuotationArticleManagementProps> = ({
  className,
  taxes = [],
        ...
        <CardHeader className="space-y-1 w-full">
          <div className="flex flex-row items-center">
            <div>
              ...
              <CardDescription>{tInvoicing('article.manager_statement_purchaseQuotation')}</CardDescription>
            </div>
          </div>
        </CardHeader>
