...
interface PurchaseQuotationDeleteDialogProps {
  className?: string;
  id?: number;
  sequential: string;
  open: boolean;
  deletePurchaseQuotation: () => void;
  isDeletionPending?: boolean;
  onClose: () => void;
}

export const PurchaseQuotationDeleteDialog: React.FC<PurchaseQuotationDeleteDialogProps> = ({
  className,
  id,
  sequential,
  open,
