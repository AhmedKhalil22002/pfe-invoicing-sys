...
interface PurchaseInvoiceDeleteDialogProps {
  className?: string;
  id?: number;
  sequential: string;
  open: boolean;
  deletePurchaseInvoice: () => void;
  isDeletionPending?: boolean;
  onClose: () => void;
}

export const PurchaseInvoiceDeleteDialog: React.FC<PurchaseInvoiceDeleteDialogProps> = ({
  className,
  id,
  sequential,
  open,
