...
interface PurchaseInvoiceDownloadDialogProps {
  className?: string;
  id: number;
  open: boolean;
  downloadPurchaseInvoice: (template: string) => void;
  isDownloadPending: boolean;
  onClose: () => void;
}

export const PurchaseInvoiceDownloadDialog: React.FC<PurchaseInvoiceDownloadDialogProps> = ({
  className,
  id,
  open,
  ...
  const body = (
    <div className={cn(className, 'grid grid-cols-2 gap-4')}>
      <div
        ...
        onClick={() => downloadPurchaseInvoice('template1')}>
        <File />
      ...
      <div
        className="flex gap-2 items-center cursor-pointer hover:bg-zinc-200 dark:hover:bg-zinc-500 rounded-lg p-4"
        onClick={() => downloadPurchaseInvoice('template2')}>
        <File />
      ...
      <div
        className="flex gap-2 items-center cursor-pointer hover:bg-zinc-200 dark:hover:bg-zinc-500 rounded-lg p-4"
        onClick={() => downloadPurchaseInvoice('template3')}>
        <File />
